...
export const MENU: MenuModule[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Plano de contas", href: "/cadastros/plano-de-contas", icon: FolderTree, permission: "account-plan.view", implemented: true },
      { label: "Categorias financeiras", href: "/cadastros/categorias", icon: Tags, permission: "categories.view", implemented: true },
      { label: "Centros de custo", href: "/cadastros/centros-de-custo", icon: Layers, permission: "cost-centers.view", implemented: true },
      { label: "Centros de resultado", href: "/cadastros/centros-de-resultado", icon: Target, permission: "result-centers.view", implemented: true },
      { label: "Projetos", href: "/cadastros/projetos", icon: FolderKanban, permission: "projects.view", implemented: true },
      { label: "Unidades de negócio", href: "/cadastros/unidades-de-negocio", icon: Network, permission: "business-units.view", implemented: true },
      { label: "Naturezas financeiras", href: "/cadastros/naturezas-financeiras", icon: Scale, permission: "financial-natures.view", implemented: true },
      { label: "Tags financeiras", href: "/cadastros/tags-financeiras", icon: TagIcon, permission: "financial-tags.view", implemented: true },
      { label: "Rateios", href: "/cadastros/rateios", icon: SplitSquareHorizontal, permission: "allocation-rules.view", implemented: true },
      { label: "Regras de classificação", href: "/cadastros/regras-de-classificacao", icon: Wand2, permission: "classification-rules.view", implemented: true },
