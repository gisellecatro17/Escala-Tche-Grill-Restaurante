...
export const MENU: MenuModule[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Agendamento bancário", href: "/financeiro/agendamento", icon: CalendarClock, permission: "payment_schedule.view", implemented: true },
      { label: "Fila de pagamentos", href: "/financeiro/agendamento/fila", icon: ListChecks, permission: "payment_schedule.view", implemented: true },
      { label: "Lotes de pagamento", href: "/financeiro/agendamento/lotes", icon: Layers, permission: "payment_schedule.view", implemented: true },
      { label: "Simulação financeira", href: "/financeiro/agendamento/simulacao", icon: LineChart, permission: "payment_schedule.view", implemented: true },
      { label: "Parâmetros do agendamento", href: "/financeiro/agendamento/parametros", icon: SlidersHorizontal, permission: "payment_schedule.edit", implemented: true },
      ...
      { label: "Conciliação bancária", href: "/financeiro/conciliacao", icon: GitCompareArrows, permission: "reconciliation.view", implemented: true },
      { label: "Importar extrato", href: "/financeiro/conciliacao/importar", icon: Upload, permission: "reconciliation.import", implemented: true },
      { label: "Extratos importados", href: "/financeiro/conciliacao/extratos", icon: FileSpreadsheet, permission: "reconciliation.view", implemented: true },
      { label: "Movimentações bancárias", href: "/financeiro/conciliacao/transacoes", icon: Layers, permission: "reconciliation.view", implemented: true },
      { label: "Fila de conciliação", href: "/financeiro/conciliacao/a-conciliar", icon: ListChecks, permission: "reconciliation.view", implemented: true },
      { label: "Sugestões de conciliação", href: "/financeiro/conciliacao/sugestoes", icon: Lightbulb, permission: "reconciliation.view", implemented: true },
      { label: "Conciliações registradas", href: "/financeiro/conciliacao/conciliadas", icon: CheckCircle2, permission: "reconciliation.view", implemented: true },
      { label: "Não identificadas", href: "/financeiro/conciliacao/nao-identificadas", icon: CircleHelp, permission: "reconciliation.view", implemented: true },
      { label: "Lançamentos sem extrato", href: "/financeiro/conciliacao/lancamentos-sem-extrato", icon: FileSearch, permission: "reconciliation.view", implemented: true },
      { label: "Transferências internas", href: "/financeiro/conciliacao/transferencias", icon: ArrowLeftRight, permission: "reconciliation.view", implemented: true },
      { label: "Modelos de importação", href: "/financeiro/conciliacao/modelos", icon: Table2, permission: "reconciliation.view", implemented: true },
      { label: "Parâmetros da conciliação", href: "/financeiro/conciliacao/configuracoes", icon: SlidersHorizontal, permission: "reconciliation.view_settings", implemented: true },
